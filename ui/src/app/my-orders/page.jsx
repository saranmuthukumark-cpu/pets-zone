...
export default function MyOrders() {
  ...
  if (!isAuthenticated && !user) {
    return (
      <div className="text-center mt-20 text-xl font-bold text-[#7f5539]">
    ...
    <div className="flex min-h-screen bg-white">
      <main className="flex-1 p-6 md:p-8 max-w-6xl mx-auto">
        ...
        {loading ? (
                ...
                <div
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-lg text-gray-700 mb-8 border-b border-[#7f5539]/20 pb-8">
                    <div>
                      ...
                      <p className="mb-2">
                        <strong className="text-[#7f5539]">Phone:</strong>{" "}
                        {order.phone}
                      </p>
                      <p className="mb-2">
                    ...
                    <div>
                      <p className="mb-2">
                        <strong className="text-[#7f5539]">Address:</strong>{" "}
                        {order.address}
                      </p>
                      <p className="mb-2">
                        <strong className="text-[#7f5539]">City:</strong>{" "}
                        {order.city}
                      </p>
                      <p className="mb-2">
                  ...
                  <div className="flex justify-end items-center border-t border-[#7f5539]/20 pt-6">
                    <p className="font-bold text-2xl text-[#7f5539]">
                      Total: ₹
                      {(order.totalAmount || actualTax + subtotal).toFixed(2)}
                    </p>
                  </div>
                </div>
              );
          ...
          <div className="p-8 text-center text-gray-500 bg-[#fff2ee]  rounded-2xl border border-gray-300 py-16">
            <p className="text-xl font-medium">No orders found</p>
            <Link href="/livestocks">
              <button className="mt-6 bg-[#7f5539] text-white px-7 py-2 rounded-md font-semibold scale-105">
                Start Buy
              </button>
            </Link>
          </div>
